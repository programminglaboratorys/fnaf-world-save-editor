...
if __name__ == "__main__":
    ...
    frames = [pygame.image.load(f"textures/characters/freddy/freddy frame  ({i}).png") for i in range(1, 11+1)]
    ...
    while True:
        ...
        twindow.fill((0, 0, 0))
        fps_text = font.render(f"PFPS: {FPS}. FPS: {round(tclock.get_fps())}", True, (255, 255, 255))
