...
class TextBox:
    ...
    def __init__(self, rect, buffer=None, blink=True, blink_timer=0.0, transparent=False, 
                 id=None, command=None, active=False, color=pg.Color("white"), font_color=pg.Color("black"), 
                 outline_color=pg.Color("black"), invalid_color=pg.Color("red"), outline_width=2,
                 active_color=pg.Color("blue"), font=None, clear_on_enter=False, inactive_on_enter=True,
                 outline_thickness=2, broder_redius=3, regex=re.compile(ACCEPTED)):
    ...
    def draw(self, surface):
        ...
        if not self.transparent:
            if outline_color: 
                pg.draw.rect(surface, outline_color, outline,self. outline_thickness, self.broder_redius)
            if self.color: 
