...
from utils.resources import FontBank, CHARACTER_TEXTURES_PATH
...
class CharacterBox:
    ...
    def load_characters_animations(self):
        ...
        for folder in glob.iglob(f"{CHARACTER_TEXTURES_PATH}\\*\\"):
            ...
            animation = Animation(frames=current_character_frames, speed=character.speed, repeat=-1)
    ...
    def __init__(self):
        ...
        self.x = 115
        self.y = 20
        self.next_textbox  = _create_textbox(self.calculate_rect_for_texbox(index=0), id="next")
        self.level_textbox = _create_textbox(self.calculate_rect_for_texbox(index=1), id="level")
    ...
    def render_character(self, surface: pygame.Surface, deltatime):
        ...
        position = add_vectors((self.x, self.y), self.size, (-(height//1.85), -(width//3)))#subtract_vectors((380, 300), (0, -20))
    ...
    def render(self, window: pygame.Surface, deltatime: int):
        ...
        level_text = render_text_with_outline("Level", FontBank.arialnb_font, (255, 255, 255), (0, 0, 0))
        level_next_text = render_text_with_outline("Next", FontBank.arialnb_font, (255, 255, 255), (0, 0, 0))
